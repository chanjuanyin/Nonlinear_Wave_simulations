...
std::pair<xt::xarray<double>, xt::xarray<double>> fix_x_varies_t(double x_1, double x_2, double x_3, double lower_bound, double upper_bound, double delta_t_) {
    ...
    xt::xarray<complex<double>> arr2 = tanh( (1/sqrt(6)) * ( (imag_i/sqrt(3)) * (x_1 + x_2 + x_3) - 2. * arr)); // u(t,(x_1,x_2,x_3)) = tanh(\frac{1}{\sqrt{6}}(\frac{i}{\sqrt{3}}(x_1+x_2+x_3)-2t))
...
int main()
{
    string directoryPath = "../Simulation_09/results";
    ...
    arr = fix_x_varies_t(x_1, x_2, x_3, 0., 3., 0.01);
    ...
    string file_name = "../Simulation_09/results/analytic.csv";
