...
int main()
{
    ...
    string resultsDirectory = "../Simulation_11/results";
    ...
    string file_name_real = "../Simulation_11/results/monte_carlo_real.csv";
    string file_name_imag = "../Simulation_11/results/monte_carlo_imag.csv";
