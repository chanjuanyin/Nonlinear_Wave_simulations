...
int main()
{
    ...
    double lambda = 0.25;
    int num_time_estimations = 31; // t from 0.0 to 3.0 (inclusive)
    ...
    xt::xarray<double> arr_real = xt::zeros<double>({num_time_estimations, num_space_estimations + 1});
    xt::xarray<double> arr_imag = xt::zeros<double>({num_time_estimations, num_space_estimations + 1});
